...
fuzzyInferenceSystem.add_set(
    name=set1_name, x_min=0, x_max=10, step=0.5, x=productLifetime_years
).add_subset(
    name="early",
    set_name=set1_name,
    membership_range=[0, 0, 1.5, 5],
    mf_type="trapezoidal",
).add_subset(
    name="mid", set_name=set1_name, membership_range=[3, 5.5, 8], mf_type="triangular"
).add_subset(
    name="mature",
    set_name=set1_name,
    membership_range=[5.5, 8, 10, 10],
    mf_type="trapezoidal",
)

set2_name = "monthly_active_users"
fuzzyInferenceSystem.add_set(
    name=set2_name, x_min=0, x_max=100, step=0.001, x=monthlyActive_kUsers
).add_subset(
    name="low", set_name=set2_name, membership_range=[0, 0, 10], mf_type="triangular"
).add_subset(
    name="mid",
    set_name=set2_name,
    membership_range=[5, 20, 50, 65],
    mf_type="trapezoidal",
).add_subset(
    name="high",
    set_name=set2_name,
    membership_range=[40, 60, 100, 100],
    mf_type="trapezoidal",
)

set3_name = "third_party_integrations"
fuzzyInferenceSystem.add_set(
    name=set3_name, x_min=0, x_max=100, step=1, x=thirdParty_integrations
).add_subset(
    name="low",
    set_name=set3_name,
    membership_range=[0, 0, 10, 20],
    mf_type="trapezoidal",
).add_subset(
    name="mid",
    set_name=set3_name,
    membership_range=[10, 25, 45, 70],
    mf_type="trapezoidal",
).add_subset(
    name="high",
    set_name=set3_name,
...
fuzzyInferenceSystem.add_set(
    name=set4_name, x_min=0, x_max=10, step=1, x=enterprise_features
).add_subset(
    name="low", set_name=set4_name, membership_range=[0, 0, 2], mf_type="triangular"
).add_subset(
    name="mid", set_name=set4_name, membership_range=[1, 2, 5, 6], mf_type="trapezoidal"
).add_subset(
    name="high",
    set_name=set4_name,
    membership_range=[5, 6, 10, 10],
    mf_type="trapezoidal",
)

set5_name = "branding"
fuzzyInferenceSystem.add_set(
    name=set5_name, x_min=0, x_max=100, step=0.1, x=branding_percent
).add_subset(
    name="budget",
    set_name=set5_name,
    membership_range=[0, 0, 10, 30],
    mf_type="trapezoidal",
).add_subset(
    name="value",
    set_name=set5_name,
    membership_range=[20, 30, 50, 70],
    mf_type="trapezoidal",
).add_subset(
    name="premium",
    set_name=set5_name,
    membership_range=[50, 65, 100, 100],
    mf_type="trapezoidal",
)

set7_name = "target_audience_mean_income"
fuzzyInferenceSystem.add_set(
    name=set7_name, x_min=0, x_max=300, step=1, x=targetAudienceMeanIncome_kUsd
).add_subset(
    name="low",
    set_name=set7_name,
    membership_range=[0, 0, 10, 45],
    mf_type="trapezoidal",
).add_subset(
    name="mid",
    set_name=set7_name,
    membership_range=[25, 60, 120, 180],
    mf_type="trapezoidal",
).add_subset(
    name="high",
    set_name=set7_name,
    membership_range=[110, 190, 300, 300],
    mf_type="trapezoidal",
)
...
fuzzyInferenceSystem.add_out_set(
    name="output_margin", x_min=0, x_max=3, step=0.01
).add_out_subset(
    name="slim", membership_range=[0, 0, 0.1, 0.25], mf_type="trapezoidal"
).add_out_subset(
    name="little", membership_range=[0.1, 0.25, 0.45, 0.7], mf_type="trapezoidal"
).add_out_subset(
    name="mid", membership_range=[0.4, 0.7, 1.1, 1.4], mf_type="trapezoidal"
).add_out_subset(
    name="high", membership_range=[1, 1.42, 1.82, 2.25], mf_type="trapezoidal"
).add_out_subset(
    name="very_high", membership_range=[1.75, 2.25, 3, 3], mf_type="trapezoidal"
)
...
rule_list = [
    ...
    [
        "Rule#4",
        "little",
        ["product_lifetime.early", "branding.value", "target_audience_mean_income.mid"],
    ],
    [
        "Rule#5",
        "mid",
        [
            "product_lifetime.early",
            "branding.premium",
            "target_audience_mean_income.high",
        ],
    ],
    ...
    [
        ...
        "high",
        [
            "product_lifetime.mid",
            "monthly_active_users.mid",
            "target_audience_mean_income.mid",
        ],
    ],
    ...
    [
        "Rule#14",
        "very_high",
        ["product_lifetime.mid", "enterprise_features.high", "branding.premium"],
    ],
    [
        "Rule#15",
        "high",
        [
            "product_lifetime.mid",
            "monthly_active_users.high",
            "third_party_integrations.high",
        ],
    ],
    [
        "Rule#16",
        ...
        [
            "product_lifetime.mid",
            "third_party_integrations.mid",
            "enterprise_features.low",
        ],
    ],
    [
        "Rule#17",
        "mid",
        ["product_lifetime.mid", "branding.budget", "target_audience_mean_income.high"],
    ],
    [
        "Rule#18",
        "little",
        [
            "product_lifetime.mature",
            "monthly_active_users.low",
            "third_party_integrations.low",
            "enterprise_features.low",
        ],
    ],
    [
    ...
    [
        ...
        [
            "product_lifetime.mature",
            "third_party_integrations.mid",
            "target_audience_mean_income.low",
        ],
    ],
    [
        "Rule#24",
    ...
    [
        "Rule#25",
        "high",
        ["product_lifetime.mature", "enterprise_features.mid", "branding.premium"],
    ],
    [
        "Rule#26",
        "high",
...
for rule_item in rule_list:
    fuzzyInferenceSystem.add_rule(
        name=rule_item[0], out_subset=rule_item[1], rules_list=rule_item[2]
    )
